# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-10-24 10:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', models.CharField(blank=True, db_index=True, max_length=10, unique=True, validators=[django.core.validators.RegexValidator(b'^[0-9]*$', b'Only numeric characters are allowed.')])),
            ],
            options={
                'ordering': ('username',),
                'verbose_name': 'User',
